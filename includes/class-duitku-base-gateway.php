...
abstract class Duitku_Base_Gateway extends WC_Payment_Gateway {
    ...
    protected function display_payment_instructions($order, $va_number, $expiry) {
        ...
        if ($order->has_status('completed')) {
            ...
            echo '<p style="margin-bottom:0;"><strong>' . sprintf( esc_html__( 'Nomor Virtual Account %s:', 'duitku-va' ), esc_html( $this->title ) ) . '</strong></p>';
            }
        ...
        echo '      var originalText = copyVaBtn.textContent;';
        ...
        echo '        copyVaBtn.textContent = "Berhasil Disalin";';
        echo '        setTimeout(function() { copyVaBtn.textContent = originalText; }, 2000);';
        echo '      }, function() {';
        ...
        echo '      var originalText = copyAmountBtn.textContent;';
        ...
        echo '        copyAmountBtn.textContent = "Berhasil Disalin";';
        echo '        setTimeout(function() { copyAmountBtn.textContent = originalText; }, 2000);';
        echo '      }, function() {';
